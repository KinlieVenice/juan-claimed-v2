...
export const globalFields: FieldDef[] = [
  {
    ...
    description: "Applicant's date of birth, used for age-based eligibility checks.",
    inputType: "DATE",
  ...
  },
  {
    ...
    description: "Total monthly income of the applicant's household, in PHP.",
    inputType: "MONEY",
    classification: "GLOBAL",
  },
  {
    ...
    description: "Number of people living in the applicant's household.",
    inputType: "NUMBER",
    classification: "GLOBAL",
  },
  {
    ...
    description: "Whether the applicant is a Filipino citizen.",
    inputType: "BOOLEAN",
    classification: "GLOBAL",
  },
  {
    ...
    description: "Applicant's current region/province/city of residence.",
  ...
  },
  {
    ...
    description: "How long the applicant has been unemployed, if applicable.",
    inputType: "DURATION",
    classification: "GLOBAL",
  },
];
    ...
    fields: [
      {
        ...
        description: "Applicant's current civil status.",
        inputType: "SINGLE_SELECT",
        options: [
      ...
      },
      {
        ...
        description: "List of dependents living with the applicant.",
        ...
        children: [
          {
            ...
            description: "Date of birth of this dependent.",
            inputType: "DATE",
          },
          {
            key: "relationship",
            ...
            description: "How this dependent is related to the applicant.",
            inputType: "SINGLE_SELECT",
            options: [
    ...
    fields: [
      {
        ...
        description: "Whether the applicant holds a valid PWD identification card.",
        inputType: "BOOLEAN",
      },
      {
        key: "disabilityType",
        ...
        description: "The primary type of disability of the applicant.",
        inputType: "SINGLE_SELECT",
        options: [
    ...
    fields: [
      {
        ...
        description: "Whether the applicant is a registered solo parent.",
        inputType: "BOOLEAN",
      },
      {
        key: "remarks",
        ...
        description: "Optional free-text remarks from the applicant.",
        inputType: "TEXT",
        required: false,
      },
      {
        ...
        description: "List of the applicant's children.",
        inputType: "REPEATER_GROUP",
        children: [
          {
            key: "birthDate",
            ...
            description: "Date of birth of this child.",
            inputType: "DATE",
          },
        ],
      },
    ...
    fields: [
      {
        ...
        description: "Whether this is the applicant's first time applying for this program.",
        inputType: "BOOLEAN",
      },
      {
        ...
        description: "Any additional vulnerability classifications that apply to the applicant.",
    ...
    fields: [
      {
        ...
        description: "Whether the household is registered as indigent (e.g. under the National Household Targeting System).",
        inputType: "BOOLEAN",
      },
      {
        ...
        description: "List of the applicant's school-age children.",
        inputType: "REPEATER_GROUP",
        children: [
          {
            key: "birthDate",
          ...
          },
          {
            ...
            description: "Whether this child is currently enrolled in school.",
            inputType: "BOOLEAN",
          },
        ],
      },
